...
<?php
$query = "SELECT * FROM book b INNER JOIN author_id a ON b.Author_ID = a.Author_ID INNER JOIN sem_book sb ON b.Book_ID = sb.Book_ID INNER JOIN student s ON sb.Student_ID = s.ID where sb.Trans_Type=1";
